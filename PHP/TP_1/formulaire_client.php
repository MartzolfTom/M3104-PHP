...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form action="exo2_page2.php" method="post">
      ...
      <input type="checkbox" name="" value=""> Ajoutez moi à la liste de diffusion <br/><br/>
      <input type="submit" name="" value="Envoyer"> <input type="reset" name="" value="Annuler"> <br/><br/>
    </form>
